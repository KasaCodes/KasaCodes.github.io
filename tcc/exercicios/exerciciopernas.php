...
$sql_exercicio_pernas= $conn_banco -> prepare('SELECT id_exercicio, nm_exercicio FROM tb_exercicios INNER JOIN tb_tipo_exer on tb_tipo_exer.id_tipo_exer = tb_exercicios. exercicio_tipo_id where tb_tipo_exer.nm_tipo_exer like"%Pernas%"');
$sql_exercicio_pernas->execute();
                    ...
                    ?>
                        <div class="form-group">
                            ...
                            <select name="exercicio" id="nm_exercicio">
                                ...
                                <?php
                                foreach($sql_exercicio_pernas as $data){?>
