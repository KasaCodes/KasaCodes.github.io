...
$sql_exercicio_semequipamento= $conn_banco -> prepare('SELECT id_exercicio, nm_exercicio FROM tb_exercicios INNER JOIN tb_tipo_exer on tb_tipo_exer.id_tipo_exer = tb_exercicios. exercicio_tipo_id where tb_tipo_exer.nm_tipo_exer like"%Triceps%"');
